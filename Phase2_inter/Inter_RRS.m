...
function [x_reconstructed, All_PSNR] = Inter_RRS(Opts, cur,ref1,ref2)
...
for i = 1:max_iterations
    ...
    x_bar = Solver_Bframe(r, x_ref1, x_ref2, Para);   
...
function [ImgRec] = Solver_Bframe(x, x_ref1, x_ref2, Para)
